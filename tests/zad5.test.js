...
describe("searchWordInArray", () => {
  it("should return value and indexOf value when the value and array is given", () => {
    ...
    expect(searchWordInArray("kamil", arrayOfWords)).to.equal(
      `Task 5: Word: kamil is in Array. Index of this word is: 8`
    );
    expect(searchWordInArray("wojtek", arrayOfWords)).to.equal(
      `Task 5: Word: wojtek is in Array. Index of this word is: 10`
    );
    expect(searchWordInArray("gosia", arrayOfWords)).to.equal(
      `Task 5: Word: gosia is in Array. Index of this word is: 2`
    );
  });
